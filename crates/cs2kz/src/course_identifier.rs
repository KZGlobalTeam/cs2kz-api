//! Utility type for identifying courses.

use std::fmt::{self, Display};

/// Courses are either identified by their ID, which is unique, or their name.
...
impl Display for CourseIdentifier {
...
impl From<u16> for CourseIdentifier {
	fn from(value: u16) -> Self {
		Self::ID(value)
	}
}

impl From<&str> for CourseIdentifier {
...
impl From<String> for CourseIdentifier {
